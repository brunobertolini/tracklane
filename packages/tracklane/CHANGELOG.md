...
- [`06ab202`](https://github.com/brunobertolini/tracklane/commit/06ab2023bb5b21fc97eb3da5f80528a055696c55) Thanks [@brunobertolini](https://github.com/brunobertolini)! - A vendor's refusal now carries the vendor's own answer. All three server providers used to throw
...
- [`6bd0363`](https://github.com/brunobertolini/tracklane/commit/6bd0363752ed5a16fbb75bb47e3554e0cc82a49d) Thanks [@brunobertolini](https://github.com/brunobertolini)! - The shared conformance suite is now published as `tracklane/conformance`.
