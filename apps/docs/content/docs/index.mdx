...
**GA4 and Meta ship today**, on both surfaces, each verified against a real account. **LinkedIn,
PostHog and X** are next. They are designed for, but not yet implemented.
